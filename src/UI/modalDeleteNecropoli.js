...
function ModalDeleteNecropoli(props) {
    ...
    const deleteAPi = async () => {
        ...
        await cm.deleteNecropoli(JSON.stringify(params)).then(res => {
            console.log('deleteNecropoli', res)
            switch (res.response) {
                case 'success':
                    alert('Necropoli eliminata con successo')
                    navigate('/home')
                    break
                case 'error':
                    alert('Impossibile eliminare la necropoli, verificare che questa sia vuota')
                    handleClose()
                    break
                default:
                    break
        ...
        <div>
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>
                        <p>Vuoi eliminare questa necropoli?</p>
                    </Modal.Title>
                </Modal.Header>
                <Form onSubmit={handleSubmit}>
                    <Modal.Body>
                        ...
                        <div className='my-5'>
                            Non sarà possibile eliminare la necropoli finché questa non sarà completemante vuota, se vuoi eliminare la tomba dovrai spostare o eliminare le tombe appartenenti a questa necropoli
                        </div>
...
export default ModalDeleteNecropoli;